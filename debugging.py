...
# Debugging
fname_final = 'debugging_results.npz'
reps = 10  # number of repetitions, 100
genes = [500]  # number of genes, 10000
n_src = [500]  # number of source data points, 1000
n_trg = 200  # overall number of target data points, 1300
percs =np.true_divide([100,200],n_trg) # Percentages of complete target data to use, 10,20,40,70,100,150,200,300,500,700,1000, 1300
cluster_spec = [1, 2, 3, [4, 5], [6, [7, 8]]]  # hierarchical cluster structure, 1, 2, 3, [4, 5], [6, [7, 8]]
common = [0, 1,5]  # different numbers of overlapping clusters in source and target data, 0, 1, 4, 5
mixes = [0.0, 0.3, 0.9,1]  # Mixture parameters of transfer learning SC3, 0.0, 0.3, 0.6, 0.9, 1
            ...
            while r < reps:
                ...
                for i in range(len(percs)):
                    ...
                    for m in range(len(methods)):
                        print('Running experiment {0} of {1}: repetition {2} of {3} source cells, {4} genes, {5} common clusters, '
