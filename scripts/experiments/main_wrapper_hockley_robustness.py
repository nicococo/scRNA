...
# Result file
fname_final = '/home/bmieth/scRNAseq/results/jims_data/multiple_reps/jimtarget_usoskinsource_level1labels_k7_100reps.npz'
...
labels_level_ind = 1 # 1,2,3 level for source labels
