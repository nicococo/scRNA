...
def plot_expression_histogram(data_matrix, num_bins=200, x_range=(0,5), y_lim=100000):
    ...
    plt.yticks([10000, 20000,30000,40000,50000,60000], ['10','20','30','40','50','60'],fontsize=13)
    #plt.show()
...
if __name__ == "__main__":
    ...
    fname_plot ='/home/bmieth/scRNAseq/results/jims_data/seurat/jimtarget_usoskinsource_2_'
    ...
    foo_l3 = np.load('/home/bmieth/scRNAseq/results/jims_data/seurat/jimtarget_usoskinsource_level3labels_k7_after_seurat_new.npz')
    #foo = np.load('/home/bmieth/scRNAseq/results/jims_data/seurat/jimtarget_usoskinsource_combined_k7_after_seurat.npz')
    ...
    #fname_data_target = '/home/bmieth/scRNAseq/data/Jim/Jim_after_Seurat.tsv'
    #fname_data_source = '/home/bmieth/scRNAseq/data/usoskin/Usoskin_after_Seurat.tsv'
    ...
    #plot_expression_histogram(data_target, num_bins=200, x_range=(0,5), y_lim=60000)
    #plt.savefig(fname_plot+'target_expression_histogram_now'+'.jpg')


    ### Figure 2 Expression histograms Source data
    #data_source = pd.read_csv(fname_data_source, sep='\t', header=None).values
    #fig = plt.figure(figsize=(8,6))
    #plot_expression_histogram(data_source, num_bins=200, x_range=(0,5), y_lim=60000)
    #plt.savefig(fname_plot+'source_expression_histogram_now'+'.jpg')	
    ...
    plt.savefig(fname_plot+'Seurat.jpg')
