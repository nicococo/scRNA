...
source.fname = "source_data_T1_100_S1_1000.tsv"
target.fname = "target_data_T1_100_S1_1000.tsv"
...
source.labels = read_tsv("source_labels_T1_100_S1_1000.tsv", col_names = FALSE)
source.labels$X1 = factor(source.labels$X1)
target.labels = read_tsv("target_labels_T1_100_S1_1000.tsv", col_names = FALSE)
